...
Mac Linux 中或者 Windows 中 可以使用 JDK 或者 IDE（Eclipse）等开发工具

不同系统的开发环境配置： https://www.runoob.com/java/java-environment-setup.html（主要是Windows）

Mac 自带 Java 开发环境，所以这里略过。
