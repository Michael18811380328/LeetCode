/**
 * 这里处理数学运算精确计算问题（number-precision处理兼容问题，性能不好，所以自己实现）
 * @desc Solve the problem of floating calculation,
 * avoid multiple digits after the decimal point and loss of calculation accuracy.
 * example: 3 + 2.4 = 4.699999999999999，1.0 - 0.9 = 0.09999999999999998
 */

/**
 * Correct wrong data 修正错误数据（保留12位精度）
...
/**
 * Return digits length of a number 返回数字的长度（科学计数法）
